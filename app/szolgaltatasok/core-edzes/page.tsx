...
export const metadata: Metadata = {
  title: 'Csoportos Gerinc és Core Edzés Győr | Törzsizomzat Erősítés',
  description: 'Kiscsoportos gerinc és core edzés Győrben. Erősítse meg törzsizomzatát, javítsa testtartását és előzze meg a gerincfájdalmakat a ReStart Physionál.',
  keywords: 'core edzés győr, csoportos gerinc torna győr, törzsizom erősítés, tartásjavító torna, hasizom edzés gerincbarát',
  alternates: { canonical: 'https://restartphysio.hu/szolgaltatasok/core-edzes' },
  openGraph: {
    title: 'Csoportos Gerinc és Core Edzés Győr | Törzsizomzat Erősítés',
    description: 'Kiscsoportos gerinc és core edzés Győrben a ReStart Physio rendelőben.',
    url: 'https://restartphysio.hu/szolgaltatasok/core-edzes',
    locale: 'hu_HU',
    type: 'website',
    images: [{ url: 'https://restartphysio.hu/group_core1.webp', width: 1200, height: 630, alt: 'Core edzés Győr' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Csoportos Gerinc és Core Edzés Győr',
    description: 'Kiscsoportos gerinc és core edzés Győrben a ReStart Physio rendelőben.',
    images: ['https://restartphysio.hu/group_core1.webp'],
  }
};
...
function CoreSchema() {
  return (
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      "name": "Csoportos Gerinc Core Edzés Győr",
      "description": "A core, vagyis a törzsizomzat megerősítése szakmai felügyelet mellett, mely a hát- és gerincfájdalmak gátja.",
      ...
      <section className="relative bg-white py-20 md:py-28 overflow-hidden border-b border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="flex mb-8 text-sm font-semibold text-gray-600" aria-label="Breadcrumb">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-[#004A6D]">Core Edzés</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center px-4 py-2 bg-[#004A6D]/10 rounded-full text-sm font-bold text-[#004A6D] mb-6 border border-[#004A6D]/20">
                Törzsizomzat erősítés
              </div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#004A6D] mb-6 leading-tight">
                Csoportos <span className="text-[#EC7007]">gerinc core</span> edzés
              </h1>
              <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed font-medium">
                Védje gerincét és teremtsen masszív, erős tartást kiscsoportos, biztonságos és funkcionális edzéseinken.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8 text-gray-700 text-lg leading-relaxed">
              <h2 className="text-3xl font-bold text-[#004A6D]">Miért fontos a Core edzés?</h2>
              <p>
                A <strong>core (törzsizomzat)</strong> a testünk stabilitásának központja, egy afféle "erőközpont", vagy fűző. Ha a has és hátizmok, különösen a mély izmok nem elég erősek, a gerinc túlterhelődik, ami mozgásszervi fájdalmakhoz és sérülésekhez vezet.
              </p>
              <p>
                Győri rendelőnkben <strong>kiscsoportos core edzéseket</strong> tartunk gyógytornász felügyeletével. A stabil és jól koordinált izommunka megtanításával tehermentesíthető a gerinc, javul a testtartás, és könnyebbé válnak a mindennapi teendők.
              </p>
            </div>

            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 p-8 h-fit lg:sticky lg:top-24">
              <h3 className="text-2xl font-bold text-[#004A6D] mb-6 border-b pb-4">Az edzés elemei</h3>
              <ul className="space-y-4">
                {[
                  "Mély has- és hátizmok bekapcsolása",
                  "Légzéstechnika alkalmazása",
                  "Funkcionális gyakorlatok",
                  "Biztonságos felügyelet és javítás"
                ].map((item, idx) => (
...
<RelatedServices currentSlug="core-edzes" />
