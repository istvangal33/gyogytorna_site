...
export const metadata: Metadata = {
  title: 'Dinamikus Tape és Kinesio Tape Győr | Ízület és Izom Támogatás',
  description: 'Dinamikus tape és kineziológiai tapaszolás Győrben. Hatékony biomechanikai támogatás sérülések, fájdalomcsillapítás és sportteljesítmény javítása érdekében.',
  keywords: 'dinamikus tape győr, kinesio tape győr, kineziológiai tapasz, sportsérülés tapaszolás, biomechanikai tape',
  alternates: { canonical: 'https://restartphysio.hu/szolgaltatasok/dinamikus-tape' },
  openGraph: {
    title: 'Dinamikus Tape és Kinesio Tape Győr | Ízület és Izom Támogatás',
    description: 'Dinamikus tape és kineziológiai tapaszolás Győrben. Hatékony biomechanikai támogatás.',
    url: 'https://restartphysio.hu/szolgaltatasok/dinamikus-tape',
    locale: 'hu_HU',
    type: 'website',
    images: [{ url: 'https://restartphysio.hu/dynamictape1.jpg', width: 1200, height: 630, alt: 'Dinamikus tape felhelyezés Győr' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Dinamikus Tape és Kinesio Tape Győr',
    description: 'Dinamikus tape és kineziológiai tapaszolás Győrben.',
    images: ['https://restartphysio.hu/dynamictape1.jpg'],
  }
};
...
function TapeSchema() {
  return (
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      "name": "Dinamikus Tape Győr",
      "description": "Biomechanikai szemléletű, innovatív tapaszolás ízületi fájdalmak és stabilitási problémák esetén.",
      "provider": { "@type": "MedicalBusiness", "name": "ReStart Physio", "url": "https://restartphysio.hu" }
    })}} />
  );
}

export default function TapeTherapyPage() {
  return (
    <>
      <TapeSchema />
      ...
      <section className="relative bg-white py-20 md:py-28 overflow-hidden border-b border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="flex mb-8 text-sm font-semibold text-gray-600" aria-label="Breadcrumb">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-[#004A6D]">Dinamikus Tape</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.1)] border-4 border-white">
              <Image
                src="/dynamictape1.jpg"
                alt="Dinamikus Tape kezelés"
                fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8 text-gray-700 text-lg leading-relaxed">
              <h2 className="text-3xl font-bold text-[#004A6D]">Miben más a Dinamikus tape?</h2>
              <p>
                A <strong>Dynamic Tape</strong> egy innovatív, biomechanikai szemléletű tapasz. Győri rendelőnkben mind dinamikus, mind hagyományos kineziológiai tapaszolást végzünk pácienseink igényeihez igazodva.
              </p>
              <p>
                Míg a klasszikus kineziológiai tapasz elsősorban neurofiziológiai hatású, a Dynamic Tape erőteljesen rugalmas, több irányban nyúlik, és képes elnyelni, majd visszaadni a mozgás során keletkező energiát. Közvetlenül biomechanikai hatást fejt ki, így támogatva az izmok munkáját és az ízületek stabilitását.
              </p>
            </div>

            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 p-8 h-fit lg:sticky lg:top-24">
              <h3 className="text-2xl font-bold text-[#004A6D] mb-6 border-b pb-4">Alkalmazási pontok</h3>
              <ul className="space-y-4">
                {[
                  "Ficamok és sérülések után",
                  "Izmok terhelésének csökkentése",
                  "Teniszkönyök, térdpanaszok",
...
<RelatedServices currentSlug="dinamikus-tape" />
