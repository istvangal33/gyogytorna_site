...
export const metadata: Metadata = {
  title: 'TMI / Állkapocs Ízületi Terápia Győr | Fájdalomcsillapítás',
  description: 'Állkapocs ízületi (TMI) terápia Győrben. Hatékony, specifikus manuálterápiás kezelés fogcsikorgatás, rágóízületi fájdalom, kattogás és korlátozott szájnyitás esetén.',
  keywords: 'állkapocs ízületi terápia győr, tmi terápia, rágóízületi fájdalom, fogcsikorgatás kezelése, állkapocs kattogás győr',
  alternates: { canonical: 'https://restartphysio.hu/szolgaltatasok/tmi-terapia' },
  openGraph: {
    title: 'TMI / Állkapocs Ízületi Terápia Győr | Fájdalomcsillapítás',
    description: 'Állkapocs ízületi (TMI) terápia Győrben. Hatékony kezelés rágóízületi fájdalom esetén.',
    url: 'https://restartphysio.hu/szolgaltatasok/tmi-terapia',
    locale: 'hu_HU',
    type: 'website',
    images: [{ url: 'https://restartphysio.hu/allkapocs1.jpg', width: 1200, height: 630, alt: 'Állkapocs ízületi terápia Győr' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'TMI / Állkapocs Ízületi Terápia Győr',
    description: 'Állkapocs ízületi (TMI) terápia Győrben. Hatékony kezelés rágóízületi fájdalom esetén.',
    images: ['https://restartphysio.hu/allkapocs1.jpg'],
  }
};
...
function TMISchema() {
  return (
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      "name": "TMI (Állkapocs Ízületi) Terápia Győr",
      "description": "Az állkapocs-ízületi (TMI) terápia a rágóízület működésének helyreállítására irányuló speciális manuális kezelés.",
      "provider": { "@type": "MedicalBusiness", "name": "ReStart Physio", "url": "https://restartphysio.hu" }
    })}} />
  );
}

export default function TMITherapyPage() {
  return (
    <>
      <TMISchema />
      ...
      <section className="relative bg-white py-20 md:py-28 overflow-hidden border-b border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="flex mb-8 text-sm font-semibold text-gray-600" aria-label="Breadcrumb">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-[#004A6D]">TMI terápia</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center px-4 py-2 bg-[#004A6D]/10 rounded-full text-sm font-bold text-[#004A6D] mb-6 border border-[#004A6D]/20">
                Állkapocs ízületi kezelés
              </div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#004A6D] mb-6 leading-tight">
                TMI / Állkapocs Ízületi <br className="hidden sm:block"/><span className="text-[#EC7007]">Terápia</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed font-medium">
                Szabaduljon meg a rágóízületi fájdalomtól, kattogástól és a fogcsikorgatás okozta feszültségtől célzott manuális technikákkal.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8 text-gray-700 text-lg leading-relaxed">
              <h2 className="text-3xl font-bold text-[#004A6D]">Mi az a TMI terápia?</h2>
              <p>
                Az <strong>állkapocs-ízületi (TMI) terápia</strong> a rágóízület (TMJ – temporomandibuláris ízület) működésének helyreállítására, fájdalmainak és mozgáskorlátozottságának csökkentésére irányuló speciális manuális kezelés Győrben.
              </p>
              <p>
                A mindennapi stressz, fogszorítás, fogcsikorgatás, helytelen testtartás vagy harapási rendellenességek gyakran okozhatnak állkapocs körüli fájdalmat, fejfájást, esetleg fülzúgást. Az <strong>állkapocs-ízületi terápia</strong> során célzott technikákkal kezeljük az érintett izmokat, kötőszöveteket és ízületeket – mind kívülről, mind a szájüregen belül, normalizálva a funkciókat.
              </p>
            </div>

            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 p-8 h-fit lg:sticky lg:top-24">
              <h3 className="text-2xl font-bold text-[#004A6D] mb-6 border-b pb-4">Milyen tünetekre jó?</h3>
              <ul className="space-y-4">
                {[
                  "Állkapocs kattogás, ropogás",
                  "Fájdalom rágáskor, ásításkor",
...
<RelatedServices currentSlug="tmi-terapia" />
