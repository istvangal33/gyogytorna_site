...
export const metadata: Metadata = {
  title: 'Sportrehabilitáció és Gyógytorna Győr | Sérülés utáni felépülés',
  description: 'Személyre szabott sportrehabilitáció és gyógytorna Győrben Forrás Fernandával. Gyors és biztonságos visszatérés a sporthoz sérülések és műtétek után.',
  keywords: 'sportrehabilitáció győr, gyógytorna győr, sportsérülés kezelés, műtét utáni rehabilitáció, keresztszalag szakadás gyógytorna, térdműtét rehabilitáció',
  alternates: {
    canonical: 'https://restartphysio.hu/szolgaltatasok/sportrehabilitacio',
  },
  openGraph: {
    title: 'Sportrehabilitáció és Gyógytorna Győr | Sérülés utáni felépülés',
    description: 'Személyre szabott sportrehabilitáció és gyógytorna Győrben Forrás Fernandával.',
    url: 'https://restartphysio.hu/szolgaltatasok/sportrehabilitacio',
    locale: 'hu_HU',
    type: 'website',
    images: [{ url: 'https://restartphysio.hu/sportrehab1.jpg', width: 1200, height: 630, alt: 'Sportrehabilitáció Győrben' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Sportrehabilitáció és Gyógytorna Győr',
    description: 'Személyre szabott sportrehabilitáció és gyógytorna Győrben.',
    images: ['https://restartphysio.hu/sportrehab1.jpg'],
  }
};

function RehabSchema() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "serviceType": "Physiotherapy",
    "name": "Sportrehabilitáció és Gyógytorna Győr",
    "description": "Személyre szabott sportrehabilitáció és gyógytorna sérülések és műtétek utáni felépüléshez.",
    "provider": {
  ...
  const breadcrumbs = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Sportrehabilitáció", "item": "https://restartphysio.hu/szolgaltatasok/sportrehabilitacio" }
    ]
  };
      ...
      <section className="relative bg-white py-20 md:py-28 overflow-hidden border-b border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="flex mb-8 text-sm font-semibold text-gray-600" aria-label="Breadcrumb">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-[#004A6D]">Sportrehabilitáció</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#004A6D] mb-6 leading-tight">
                Visszatérés a mozgáshoz <br className="hidden sm:block"/><span className="text-[#EC7007]">Sportrehabilitációval</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed font-medium">
                Biztonságos és teljes körű felépülés sérülésekből és műtétekből hobbi- és élsportolók számára egyaránt a győri ReStart Physio rendelőben.
              </p>
            ...
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.1)] border-4 border-white">
              <Image
                src="/sportrehab1.jpg"
                alt="Sportrehabilitáció kezelés Győrben"
                fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8 text-gray-700 text-lg leading-relaxed">
              <h2 className="text-3xl font-bold text-[#004A6D]">Miről szól a sportrehabilitáció?</h2>
              <p>
                A sportrehabilitáció célja, hogy a sérülést követően a sportoló – legyen hobbi vagy élsportoló – minél gyorsabban, biztonságosan és teljes értékűen térhessen vissza az edzéshez vagy versenyzéshez.
              </p>
              <p>
                Győri rendelőnkben a kezelés nem csupán a fájdalomcsillapításról szól, hanem a teljes funkció helyreállításáról és a sérülés újbóli kialakulásának minimalizálásáról. A személyre szabott kezelési tervben ötvözzük a manuálterápiát és a funkcionális gyakorlatokat. Megtanítjuk a helyes mozgásmintákat, javítjuk a mobilitást, koordinációt, stabilitást, dinamikát és az erőnlétet.
              </p>

              <h2 className="text-3xl font-bold text-[#004A6D] pt-8">A rehabilitáció folyamata</h2>
              <ul className="list-disc pl-6 space-y-2 mt-4">
                <li>Korai mobilizáció és fájdalomcsökkentés a sérülés utáni első szakaszban</li>
                <li>Az ízületi mozgásterjedelem maradéktalan helyreállítása</li>
                <li>Az izomerő és az izom-állóképesség specifikus fejlesztése</li>
                <li>Sportág-specifikus mozgásminták beépítése és begyakorlása</li>
                <li>Prevenció: a sérülés ismétlődésének elkerülésére felkészítő stabilizáló tréning</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 p-8 h-fit lg:sticky lg:top-24">
              ...
              <ul className="space-y-4">
                {[
                  "Sportsérülések (húzódás, szakadás)",
                  "Keresztszalag / meniscus sérülés",
                  "Műtét utáni rehabilitáció (térd, váll)",
                  "Túlterheléses panaszok",
                  "Sportba való biztonságos visszatéréshez"
                ].map((item, idx) => (
...
<RelatedServices currentSlug="sportrehabilitacio" />
